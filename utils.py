...
class Metric_calculator:
    def __init__(self, text_trunc_length=1024):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('/data/ruijie/load_models/allenai/scibert_scivocab_uncased', use_fast=False, padding_side='right')
    ...
    def __call__(self, gt_list, pred_list, use_tokenizer=False):
        ...
        print(f'Average Meteor score: {_meteor_score:.2f}')
        print(f'rouge1: {rouge_1:.2f}',)
        print(f'rouge2: {rouge_2:.2f}',)
        print(f'rougeL: {rouge_l:.2f}',)
        
        print(f'Validity: {validity:.2f}')
        print(f'Accuracy (100): {acc_100:.2f}')
        print(f'Accuracy (90): {acc_90:.2f}')
        print(f'Accuracy (75): {acc_75:.2f}')
        print(f'Accuracy (50): {acc_50:.2f}')

        line = ''
        for score in [validity, bleu2, bleu4, acc_100, acc_90, acc_75, acc_50, rouge_1, rouge_2, rouge_l]:
            line += f'{score:.2f} | '
        print(line)
